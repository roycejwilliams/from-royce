...
export default function BlogSlugPage() {
  ...
  const slug = generateSlug(post_title); // ✅ this was missing
    ...
    <>
      ...
      <div className="bg-[#FFF6F6] text-black min-h-[100svh]">
        ...
        <div className="xl:p-24 p-8 font-anonymous">
          ...
          <p className="text-sm font-medium mt-8 uppercase">Date: {selectedPost.formatted_date}</p>
          <p className="text-sm font-medium mt-8 uppercase">Time: {selectedPost.formatted_time}</p>
